            ...
            <div className="card">
                ...
                <div className="mt-3">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        </div>  <div className="d-flex flex-row"> <button className="btn btn-success mr-2 font-weight-bold" style={{fontSize:"1rem"}}>강의시작</button><button className="btn btn-danger mr-2 font-weight-bold" style={{fontSize:"1rem"}}> 강의관리</button> </div>
                    </div>
                </div>
                <div className="mt-3">
                    <div className="d-flex justify-content-between align-items-center">
